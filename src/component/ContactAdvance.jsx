    ...
    return (
        <div>
            ...
            <section id='locations'>
                <div className='h-52 sm:h-64 md:h-80 lg:h-96 flex justify-center items-center'>
                    <AnimateText text={"Our Location"} triggerId={"locations"} splitType='chars' animation='slide-right' />
                </div>
